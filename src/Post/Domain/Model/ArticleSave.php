 ...
 * @ORM\Entity(repositoryClass="ArticleDoctrineRepository")
 */
class ArticleSave
{
     ...
     * @var UrlPost url
     *
     * @ORM\OneToOne(targetEntity="\App\Core\Domain\Model\UrlArticle", cascade={"all"}, fetch="EAGER")s
    ...
    /**
     * @ORM\OneToOne(targetEntity="\App\Core\Domain\Model\Video\Youtube", cascade={"all"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="\App\Agenda\Domain\Model\Evenement", mappedBy="articles", cascade={"all"})
     */
     ...
     * Set title.
     */
    public function setUrl(UrlPost $url)
    {
        $this->url = $url;
     ...
     * Get url.
     */
    public function getUrl(): UrlPost
    {
        return $this->url;
    }
    ...
    {
        return $this->title ? $this->title : 'New Post';
    }
