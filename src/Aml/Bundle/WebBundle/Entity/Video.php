 ...
 *
 * @ORM\Entity(repositoryClass="Aml\Bundle\WebBundle\Repository\VideoRepository")
 *
 * @ORM\Table(name="WebBundle_videos")
 * @ORM\InheritanceType("SINGLE_TABLE")
 * @ORM\DiscriminatorColumn(name="provider", type="string")
 * @ORM\DiscriminatorMap({
 *     "youtube" = "\Aml\Bundle\WebBundle\Entity\Video\Youtube",
 *     "dailymotion" = "\Aml\Bundle\WebBundle\Entity\Video\Dailymotion"
 * })
 */
