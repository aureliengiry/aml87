...
/**
 * App\Media\Domain\Model\Image.
 *
 * @ORM\HasLifecycleCallbacks
 * @ORM\Entity(repositoryClass="App\Media\Infrastructure\Doctrine\ImageDoctrineRepository")
 */
class Image extends Media
{
    /**
     * @ORM\OneToOne(targetEntity="\App\Discography\Domain\Model\Album", mappedBy="image")
     */
    protected $album;
